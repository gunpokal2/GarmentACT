...
from .transformer_yoseph_v3 import build_transformer, TransformerEncoder, TransformerEncoderLayer
### yoseph ###
from .pointnet2_yoseph_v3 import build_pointnet2
### yoseph ###
...
class DETRVAE(nn.Module):
    ...
    def __init__(self, env_pcd_encoder, backbones, transformer, encoder, state_dim, num_queries, camera_names):
        ...
        self.additional_pos_embed = nn.Embedding(4, hidden_dim) # Embedding(2, 512) # learned position embedding for latent, qpos, env, stage
        pcd_feat_dim = 128
