...
from .transformer_yoseph_v2 import build_transformer, TransformerEncoder, TransformerEncoderLayer
### yoseph ###
from .pointnet2_yoseph_v2 import build_pointnet2
### yoseph ###
...
class DETRVAE(nn.Module):
    ...
    def __init__(self, garment_pcd_encoder, env_pcd_encoder, backbones, transformer, encoder, state_dim, num_queries, camera_names):
        ...
        self.additional_pos_embed = nn.Embedding(6, hidden_dim) # Embedding(2, 512) # learned position embedding for latent, qpos, env, stage, garment slot 1, garment slot 2
        pcd_feat_dim = 128
    ...
    def forward(self, 
        ...
        return a_hat, is_pad_hat, stage_logits, [mu, logvar]
...
def build(args):
    ...
    ### yoseph ###
    garment_pcd_encoder, env_pcd_encoder = build_pointnet2()
    ### yoseph ###
    # From state
